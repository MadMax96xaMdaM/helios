...
export class MoviePage implements OnInit {
  ...
  loadPlugin() {
    ...
    // );
    const data = JSON.parse(
      `{"movie":{"relatedIds":[],"title":"L'ennui","year":1998,"imdbId":"tt0168740","tmdbId":55107,"traktId":39133,"trailer":null,"certification":null,"tagline":"","overview":"A philosophy teacher restless with the need to do something with his life meets a young woman suspected of driving an artist to his death. He finds the very simple Cecilia irritating but develops a sexual rapport with her. Obsessed with the need to own and tormented by her inability to respond to him, he becomes increasingly violent in a quest he can't name - a quest that slowly begins to undermine his certainties.","released":"1998-11-14","runtime":122,"rating":5.9,"votes":10,"language":"fr","genres":["drama","romance"],"images_url":{"poster":"https://image.tmdb.org/t/p/w300/p5gAhWf1rZGJcMs4Kdu6FH9CcG5.jpg","backdrop":"https://image.tmdb.org/t/p/w500/oEzMMrcxv8O6S7uBTH3tYuwK77i.jpg","poster_original":"https://image.tmdb.org/t/p/original/p5gAhWf1rZGJcMs4Kdu6FH9CcG5.jpg","backdrop_original":"https://image.tmdb.org/t/p/original/oEzMMrcxv8O6S7uBTH3tYuwK77i.jpg"},"alternativeTitles":{"us":"L'ennui","fr":"L'ennui","it":"La noia","de":"Meine Heldin","es":"Tedio","ru":"Желание","cn":"马丁的恋情","cz":"Ennui","kr":"권태","nl":"L'ennui"},"originalTitle":"L'ennui"}}`
    );
